            ...
            <tbody className="bg-white">
              {links?.map((link) => (
                ...
                >
                  ...
                  <td className="whitespace-nowrap px-3 py-3">
                    {link.tags.map(tag => (<Button type="button" className="py-2.5 px-5 me-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-full border border-gray-200 hover:bg-gray-100 hover:text-green-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">{tag}</Button>))}
                  </td>
                  <td className="whitespace-nowrap py-3 pl-6 pr-3">
